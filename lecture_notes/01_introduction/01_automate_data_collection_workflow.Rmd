...
2. Learning how to automate the data collecting and wrangling process
...
1. What's the data type (structured, semi-structured, and unstructured) of the document that appeared in the left panel in Figure 1? 

2. What's the data type (structured, semi-structured, and unstructured) of the document that appeared in the right panel in Figure 1? 
...
- I wrote this tutorial only for educational purpose.
...
- Note that if you scrape too much information from the platform too quickly, you will be prohibited from using it for a while.
...
- Step 1 (divide): Split the large target file. (You can easily do this in the command-line using `split` command. We're not learning this today ... )

- Step 2 (conquer): Wrangle each split file. (We already learned how to do this.)

- Step 3 (reduce): Combine them. (Something new. This is what we're learning in this subsection of the workshop.)
...
- The following toy example comes from Wickham's [Advanced R](https://adv-r.hadley.nz/functionals.html#reduce).

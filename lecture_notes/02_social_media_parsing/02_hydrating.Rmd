...
You can collect Twitter data using Twitter's API or hydrate Tweet IDs collected by other researchers. This is an excellent resource for collecting historical Twitter data.
...
- Even though you don't know how to write Python code or shell scripts, it's really useful to know how to integrate them into your R workflow.
...
1. Collect tweets containing some keywords of your choice using `twarc search` and save them as `tweets.jsonl`. 
